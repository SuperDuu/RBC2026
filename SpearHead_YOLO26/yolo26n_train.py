...
def train_best_model():
    ...
    # Khởi tạo mô hình YOLO26
    model = YOLO('/home/du/Desktop/RBC2026/yolo26n.pt') 
    ...
    model.train(
        ...
        close_mosaic=20       # Giữ nguyên 20 epoch cuối tắt Augmentation để hội tụ chính xác
    )
